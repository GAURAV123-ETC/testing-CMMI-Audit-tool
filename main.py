...
from app.gui.pages import add_project, login, dashboard, audit_workspace, evidence_scan, rule_catalog
...
login.register(); dashboard.register(); audit_workspace.register(); add_project.register(); rule_catalog.register(); evidence_scan.register()
